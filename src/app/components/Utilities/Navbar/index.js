...
const Navbar = () => {
  ...
  const renderDropdownLinks = (type) =>
    DROPDOWN_LINKS[type].map(({ href, text }) => (
      <Link
        key={href}
        href={href}
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-6 flex justify-between items-center w-full">
          ...
          <div className="hidden md:flex flex-1 justify-center space-x-6 text-lg dropdown-container">
            ...
            <Link
              href="/genres"
              className={`${
                isActivePath("/genres") ? "text-purple-500" : "text-white"
              } hover:text-purple-300 transition duration-300`}
            >
              Genre
            </Link>
            ...
            <Link
              href="/bookmark"
              className={`${
                isActivePath("/bookmark") ? "text-purple-500" : "text-white"
              } hover:text-purple-300 transition duration-300`}
            >
              Bookmark
            </Link>
            ...
            <div className="flex-1 overflow-y-auto px-6 space-y-4 dropdown-container pt-4">
              ...
              <div className="flex flex-col pt-3 dropdown-group">
                ...
                {mobileStates.dropdown === "anime" && (
                  <div className="ml-4 mt-2 space-y-3">
                    {DROPDOWN_LINKS.anime.map(({ href, text }) => (
                      <Link
                        key={href}
                        href={href}
              ...
              <div className="flex flex-col dropdown-group">
                ...
                {mobileStates.dropdown === "manga" && (
                  <div className="ml-4 mt-2 space-y-3">
                    {DROPDOWN_LINKS.manga.map(({ href, text }) => (
                      <Link
                        key={href}
                        href={href}
                        className="block text-gray-200 font-medium text-sm"
              ...
              <Link
                ...
                className={`${
                  isActivePath("/bookmark") ? "text-purple-500" : "text-white"
                } text-base font-medium hover:text-purple-300`}
                onClick={() => toggleMobileState("menu", false)}
              >
                Bookmark
              </Link>
