...
import GenreSelectorManga from "./GenreManga/GenreSelector";
import GenreFilterManga from "./GenreManga/GenreFilterBar";
import GenreMangaGrid from "./GenreManga/GenreMangaGrid";
...
export default function GenreSearchMangaClient() {
  ...
  return (
    <div className="xl:pl-10 md:pl-4 pl-2 pr-2 xl:pr-10">
      {isLoading && (
          ...
          <div className="md:p-1 mb-6 bg-white dark:bg-gray-800/10 rounded-lg shadow-md">
            ...
            {selectedGenres.length > 0 && (
              <>
                ...
                />
                <div className="mt-4">
                  <GenreMangaGrid genreIds={selectedGenres} filters={filters} />
                </div>
              </>
            )}
          </div>
